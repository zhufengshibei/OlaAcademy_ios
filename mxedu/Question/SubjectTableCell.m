...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        pointImage.backgroundColor = COMMONBLUECOLOR;
        ...
        lineImage.backgroundColor = RGBCOLOR(233, 233, 233);
        ...
        _scoreL.backgroundColor = COMMONBLUECOLOR;
        _scoreL.textColor = [UIColor whiteColor];
        ...
        [_progressView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(_scoreL.mas_right).offset(10);
...
-(void) setCellWithModel:(Course*)course{
    ...
    _scoreL.text = [NSString stringWithFormat:@"预测%@分",course.playcount];
