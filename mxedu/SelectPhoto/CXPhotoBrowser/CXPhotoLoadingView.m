...
@property (nonatomic, weak) CXPhoto *photo;
...
- (id)initWithPhoto:(CXPhoto *)photo
{
    ...
    if (self)
    {
        ...
        failureLabel.font = [NTFont systemFontOfSize:14];
    }
    return self;
}
#pragma mark - PV
...
- (void)displayFailure
{
    ...
    [reloadButton.titleLabel setFont:[NTFont systemFontOfSize:12]];
    [reloadButton setTitle:NSLocalizedString(@"重新加载",@"重新加载") forState:UIControlStateNormal];
    ...
    [failureLabel setText:NSLocalizedString(@"加载图片失败！",nil)];
    [failureLabel setFont:[NTFont systemFontOfSize:20]];
