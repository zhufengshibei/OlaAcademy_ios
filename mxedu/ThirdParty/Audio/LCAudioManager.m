...
-(void)pausePlaying
{
   [[LCAudioPlay sharedInstance] pausePlaying];
}
- (BOOL)isPlaying
{
...
- (NSString *)WAVFilePath:(NSString *)aFilePath
{
    return [[aFilePath stringByDeletingPathExtension] stringByAppendingPathExtension:@"wav"];
}
