...
#define APP_ID          @"wxbb88b0b8e23e130f"               //APPID
#define APP_SECRET      @"995fb3da51ae42c5abe4e3ea07f3ea7c" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1315757101"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"5tAS8IcojhHdnLjTYHLwysNlfi7asCoA"
//支付结果回调页面
