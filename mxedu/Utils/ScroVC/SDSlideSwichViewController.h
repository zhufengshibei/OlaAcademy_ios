...
@protocol SDSlideSwichViewDelegate <NSObject>

-(void)didSelectRowAtIndexPathModal:(id)object viewController:(VideoTerminalListSubView *)VC indexPath:(NSIndexPath *)path;//点击cell时候触发的代理
-(void)loadUpData:(id)object viewController:(VideoTerminalListSubView *)VC;//视图更新更新
...
@property (nonatomic ,assign)id<SDSlideSwichViewDelegate>delegat;//
