...
@interface ChenxingQAViewController ()

@end

@implementation ChenxingQAViewController
{
    UIWebView *webView;
}
...
- (void)viewDidLoad {
    ...
    [self.navigationItem setTitle:@"成长计划Q&A"];
...
#pragma mark 加载pdf文件
- (void)loadPDF { NSString *path = [[NSBundle mainBundle] pathForResource:@"晨星成长计划Q&A.pdf" ofType:nil];
