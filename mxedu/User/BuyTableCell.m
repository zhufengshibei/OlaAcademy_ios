...
-(void)setupCellWithModel:(Commodity*) model{
    [_videoImage setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@", model.url]] placeholderImage:[UIImage imageNamed:@"ic_video"]];
    _nameLabel.text = model.name;
    _timeLabel.text = [NSString stringWithFormat:@"%@学时，%@分钟",model.videonum, model.totaltime];
}
